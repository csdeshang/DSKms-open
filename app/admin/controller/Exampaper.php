...
class Exampaper extends AdminControl {
    ...
    public function edit() {
        ...
        if (!request()->isPost()) {
            if($exampaper['goods_id']){
                $goods_model=model('goods');
                $goods_info=$goods_model->getGoodsOnlineInfoByID($exampaper['goods_id']);
                $exampaper['goods_name']=$goods_info['goods_name'];
            }
            View::assign('exampaper', $exampaper);
            return View::fetch('form');
        } else {
    ...
    public function search_goods(){
        ...
        $goods_list=$goods_model->getGoodsOnlineList($condition,'*',20);
