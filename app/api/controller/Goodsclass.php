    ...
    public function index()
    {
        ...
        if (empty($result)) {
            ...
            foreach ($result['class_list'] as $k1 => $v1) {
                $result['class_list'][$k1]['commis_rate']=$goodsclass_list[$v1['id']]['commis_rate'];
                foreach ($v1['children'] as $k2 => $v2) {
                    $result['class_list'][$k1]['children'][$k2]['commis_rate']=$goodsclass_list[$v2['id']]['commis_rate'];
                    foreach ($v2['children'] as $k3 => $v3) {
                        $result['class_list'][$k1]['children'][$k2]['children'][$k3]['commis_rate']=$goodsclass_list[$v3['id']]['commis_rate'];
